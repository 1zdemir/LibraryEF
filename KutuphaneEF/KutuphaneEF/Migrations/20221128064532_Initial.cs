    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLocations", x => new { x.ISBN, x.LibraryId });
                    table.ForeignKey(
                        name: "FK_BookLocations_Books_ISBN",
                        column: x => x.ISBN,
                        principalTable: "Books",
                        principalColumn: "ISBN",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLocations_Libraries_LibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLocations_LibraryId",
                table: "BookLocations",
                column: "LibraryId");
